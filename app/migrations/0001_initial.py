    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('catogary', models.CharField(choices=[('M', 'MOBILE'), ('L', 'Loptop'), ('TW', 'Top Wear'), ('BW', 'Bottom Wear')], max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Accepted', 'Accepted'), ('Packed', 'Packed'), ('shipped', 'shipped'), ('Delivered', 'Delivered'), ('Cancel', 'Cancel')], default='pending', max_length=50)),
